...
export const CHARACTER_DISPLAY_HEIGHT: Record<CharacterType, number> = {
  [CharacterType.Bug]: (52 / 1.5) * 0.7 * 1.5,
...
/** Walk-cycle frame rate (sprite frames/sec — not road scroll speed). */
export const CHARACTER_FRAME_RATE: Record<CharacterType, number> = {
  /** Was 72 originally; brief peak ~162; settle slower for readability. */
  [CharacterType.Bug]: 96,
